...
const WhyMicrofab = () => {
  return (
    ...
    <div class="transition-all duration-300 ease-in-out font-ClashDisplay w-[94%] md:w-[96%] md:h-full md:m-0 md:mr-4 m-4 hover:shadow-md hover:bg-[#a0b4b7] rounded-[16px] hover:shadow-gray-400 bg-gray-300 rounded-16 justify-center flex flex-col overflow-hidden">
      {/* top */}
