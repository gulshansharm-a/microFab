...
const WhyMicrofab = () => {
  return (
    <div className="w-[94%] md:w-[96%] md:h-[116px] md:m-0 md:mr-4 m-4 bg-[#cdd7d8] rounded-[16px] flex flex-col overflow-hidden">
      {/* top */}
      <div className="md:flex md:flex-col md:h-[50%] md:w-[50%] h-[40%] w-[45%] mt-[5px] ml-[5px] ">
